...
static void RPY_matvec_nt_intrin(MATVEC_KRNL_PARAM)
{
    EXTRACT_3D_COORD();
    CALC_RPY_CONST();
    for (int i = 0; i < n0; i++)
...
static void RPY_matvec_nt_t_intrin(SYMM_MATVEC_KRNL_PARAM)
{
    EXTRACT_3D_COORD();
    CALC_RPY_CONST();
    for (int i = 0; i < n0; i++)
...
static void RPY_matvec_intrin(SYMM_MATVEC_KRNL_PARAM)
{
    if (x_in_1 == NULL)
    {
